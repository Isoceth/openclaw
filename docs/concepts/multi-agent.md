...
4. `guildId` (Discord)
5. `teamId` (Slack)
6. `workspaceId` (webchat)
7. `accountId` match for a channel
8. channel-level match (`accountId: "*"`)
9. fallback to default agent (`agents.list[].default`, else first list entry, default: `main`)
